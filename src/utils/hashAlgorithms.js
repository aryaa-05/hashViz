...
export function murmurHash3(message) {
  ...
  for (; i + 3 < len; i += 4) {
    k = utf8[i] | (utf8[i + 1] << 8) | (utf8[i + 2] << 16) | (utf8[i + 3] << 24);
...
export function md5(message) {
    ...
    const K = Array.from({length: 64}, (_, i) => Math.floor(4294967296 * Math.abs(Math.sin(i + 1))) | 0);
...
export const algorithms = [
  { id: 'fnv1', name: 'FNV-1', fn: fnv1_64, type: 'non-cryptographic', bits: 64 },
  { id: 'fnv1a', name: 'FNV-1a', fn: fnv1a_64, type: 'non-cryptographic', bits: 64 },
  { id: 'murmur3', name: 'MurmurHash3', fn: murmurHash3, type: 'non-cryptographic', bits: 32 },
  { id: 'md5', name: 'MD5', fn: md5, type: 'cryptographic', bits: 128 },
  { id: 'sha1', name: 'SHA-1', fn: sha1, type: 'cryptographic', bits: 160 },
  { id: 'sha256', name: 'SHA-256', fn: sha256, type: 'cryptographic', bits: 256 }
];
